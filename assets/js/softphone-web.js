...
class WebRTCSoftphone {
    ...
    _getAudioBaseUrl() {
        ...
        // Fallback: si la página está bajo /views, una ruta relativa típica es ../assets/audio/
        return '../assets/audio/';
    }
    ...
    async makeCall() {
        ...
        const inviter = new SIP.Inviter(this.userAgent, targetUri, {
            ...
            sessionDescriptionHandlerFactoryOptions: {
                ...
                // FIX: Timeout optimizado para llamadas salientes
                iceGatheringTimeout: 1000,
                rtcConfiguration: (() => {
            ...
            sessionDescriptionHandlerOptions: {
                ...
                // NOTA: rtcConfiguration/iceServers/mediaStreamFactory se pasan arriba por FactoryOptions.
            },
            requestDelegate: {
                onAccept: (response) => {
    ...
    endCall(playSound = true) {
        ...
        // Limpieza: se removió telemetría debug local (127.0.0.1:7552) que generaba errores en consola.
        // #endregion
